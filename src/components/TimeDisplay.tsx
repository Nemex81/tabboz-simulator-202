...
export const TimeDisplay = React.memo(function TimeDisplay({ gameTime, currentPhase, dayType, interazioniRimaste }: TimeDisplayProps) {
  return (
    <div
      ...
      aria-live="polite"
      aria-atomic="true"
      className="flex flex-wrap items-center gap-x-4 gap-y-2 px-3 py-2 border border-border rounded-sm bg-card text-sm divide-x divide-border/60 [&>*:not(:first-child)]:pl-4"
    >
